...
public class ClientDto
{
    ...
    public string cltFullName => $"{cltName} {cltSurname}";
    ...
    public DateTime cltCreatedDate { get; set; }
    public string cltCreatedUser { get; set; }
    public DateTime? cltUpdatedDate { get; set; }
    public string cltUpdatedUser { get; set; }
}
